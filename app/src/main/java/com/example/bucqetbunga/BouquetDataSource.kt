...
class BouquetDataSource {
    package com.example.bucqetbunga.data

    import com.example.bucqetbunga.R
    import com.example.bucqetbunga.models.Bouquet
    import com.example.bucqetbunga.models.BouquetCategory

    object BouquetDataSource {
        fun getBouquets(): List<Bouquet> = listOf(
            // Catatan: Harga diubah ke Double (Contoh: 75000.0)
            // Catatan: imageResId diubah ke R.drawable.nama_file_anda (GANTI ic_launcher_foreground)
            ...
            Bouquet(20, "Katty", "Full Of Red Rose", 800000.0, BouquetCategory.FRESH, 3, R.drawable.ic_launcher_foreground),
            Bouquet(21, "Mika", "Mix Flower", 170000.0, BouquetCategory.FRESH, 14, R.drawable.ic_launcher_foreground),
            ...
            Bouquet(24, "Jean", "Mix Aster", 90000.0, BouquetCategory.FRESH, 18, R.drawable.ic_launcher_foreground),
